...
mixin _$Car {
  ...
  String? get complectation => throw _privateConstructorUsedError;
  @JsonKey(name: "drive")
  String? get drive => throw _privateConstructorUsedError;
...
abstract class $CarCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: "complectation") String? complectation,
      @JsonKey(name: "drive") String? drive,
...
class _$CarCopyWithImpl<$Res, $Val extends Car> implements $CarCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? complectation = freezed,
    Object? drive = freezed,
    ...
    return _then(_value.copyWith(
      ...
      color: freezed == color
          ...
          : color // ignore: cast_nullable_to_non_nullable
              as String?,
      complectation: freezed == complectation
          ? _value.complectation
          : complectation // ignore: cast_nullable_to_non_nullable
              as String?,
      drive: freezed == drive
          ? _value.drive
...
class _$CarImpl implements _Car {
  const _$CarImpl(
      ...
      @JsonKey(name: "complectation") this.complectation,
      @JsonKey(name: "drive") this.drive,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.complectation, complectation) ||
                other.complectation == complectation) &&
...
abstract class _Car implements Car {
  const factory _Car(
      ...
      @JsonKey(name: "complectation") final String? complectation,
      @JsonKey(name: "drive") final String? drive,
